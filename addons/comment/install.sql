...
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__comment_article`;
CREATE TABLE `__PREFIX__comment_article` (
...
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__comment_like`;
CREATE TABLE `__PREFIX__comment_like` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__comment_post`;
CREATE TABLE `__PREFIX__comment_post` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) DEFAULT NULL COMMENT '会员ID',
...
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__comment_report`;
CREATE TABLE `__PREFIX__comment_report` (
...
-- ----------------------------
DROP TABLE IF EXISTS `__PREFIX__comment_site`;
CREATE TABLE `__PREFIX__comment_site` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
