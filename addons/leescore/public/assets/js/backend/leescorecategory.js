define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'leescorecategory/index',
                    add_url: 'leescorecategory/add',
                    edit_url: 'leescorecategory/edit',
                    del_url: 'leescorecategory/del',
                    multi_url: 'leescorecategory/multi',
                    table: 'leescore_category',
                }
            });
