            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-add="<?php echo $auth->check('scoreorder/send'); ?>" 
                           data-operate-edit="<?php echo $auth->check('scoreorder/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('scoreorder/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
