...
<link rel="stylesheet" href="/assets/home/css/cropper.min.css">
<link rel="stylesheet" href="/assets/home/css/ImgCropping.css">
                ...
                <div class="panel-body">
                    ...
                    <form id="profile-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('api/user/profile'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <input id="c-birthday" data-rule="date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="birthday" type="text" value="<?php if($user['birthday']!=='0000-00-00'): ?><?php echo $user['birthday']; endif; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group layui-form">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <select id="c-country" name="country"  style="display: none" data-rule="<?php echo __('Country'); ?>:required" lay-search>
                                    ...
                                    <option value="<?php echo $vo['country_en']; ?>" <?php if($vo['country_en']==$user['country']): ?>selected<?php endif; ?>><?php echo $vo['shortname1']; ?>--<?php echo __($vo['country_en'],'country'); ?></option>
                        ...
                        <div class="form-group layui-form">
                            ...
                            <div class="col-xs-12 col-sm-10">
                                ...
                                <input type="checkbox" name="interest[]" title="<?php echo __($vo['name_en']); ?>" value="<?php echo $vo['name_en']; ?>" <?php if($user['interest']): if(in_array($vo['name_en'],$user['interest'])): ?>checked<?php endif; endif; ?>>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
...
<script src="/assets/home/js/cropper.min.js"></script>
<script>
...
*/
    ...
    $("#sureCut").on("click",function () {
        if ($("#tailoringImg").attr("src") == null ){
            ...
            $.post('<?php echo url("api/common/uploadbase64"); ?>',{image:base64url},function (res) {
                if(res.code == 1){
                    layer.msg(res.msg);
                    $('#c-avatar').val(res.data.url);
                    $('.profile-user-img').prop('src',res.data.url);
