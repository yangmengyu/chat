<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"E:\phpstudy\WWW\chat\public/../application/admin\view\command\add.html";i:1530339676;s:63:"E:\phpstudy\WWW\chat\application\admin\view\layout\default.html";i:1530232546;s:60:"E:\phpstudy\WWW\chat\application\admin\view\common\meta.html";i:1530232546;s:62:"E:\phpstudy\WWW\chat\application\admin\view\common\script.html";i:1530232546;}*/ ?>
<!DOCTYPE html>
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        <label>自定义控制器名</label>
                                        <input type="text" class="form-control" name="controller" data-toggle="tooltip" title="默认根据表名自动生成,如果需要放在二级目录请手动填写" placeholder="支持目录层级">
                                    </div>
                                    <div class="col-xs-3">
                                        <label>自定义模型名</label>
