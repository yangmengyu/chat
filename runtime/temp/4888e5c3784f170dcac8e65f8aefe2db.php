    ...
    layui.use(['layer','upload','element','flow'], function(){
        ...
        upload.render({ //上传图片
            ...
            before: function(obj) {
                ...
                layer.close(layer.msg('<?php echo __("Upload successful"); ?>'));
            ...
            ,error: function(){
                layer.msg('<?php echo __("You have no permission"); ?>');
            }
        });
                    ...
                    if(res.code == 1){
                        ...
                        layui.each(res.data.dynamic, function(index, item){
                            var str = '<li class="layui-timeline-item">\n' +
                                ...
                                '<p style="margin-bottom: 10px;"> '+replace_em(item.content)+'</p>\n' +
