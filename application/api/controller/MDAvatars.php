...
class MDAvatars extends Api
{
    ...
    function __construct($Char, $AvatarSize = 256)
    {
        ...
        $this->LetterFont      = ROOT_PATH . '/public/fonts/SourceCodePro-Light.ttf';
        $this->AsianFont       = ROOT_PATH . '/public/fonts/SourceHanSansCN-Normal.ttf';
